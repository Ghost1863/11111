      ...
      >
        ...
        {showShadows && (
          ...
          >
            <div
              className={cn(
                "absolute left-0 top-0 w-full h-(--shadow-size)",
                "bg-linear-to-b from-ui-bg-subtle to-transparent opacity-0 transition-opacity",
                { "opacity-100": canScrollTop },
              )}
            />
            <div
              className={cn(
                "absolute bottom-0 left-0 w-full h-(--shadow-size)",
                "bg-linear-to-t from-ui-bg-subtle to-transparent opacity-0 transition-opacity",
                { "opacity-100": canScrollBottom },
              )}
            />
            <div
              className={cn(
                "absolute left-0 top-0 h-full w-(--shadow-size)",
                "bg-linear-to-r from-ui-bg-subtle to-transparent opacity-0 transition-opacity",
                { "opacity-100": canScrollLeft },
              )}
            />
            <div
              className={cn(
                "absolute right-0 top-0 h-full w-(--shadow-size)",
                "bg-linear-to-l from-ui-bg-subtle to-transparent opacity-0 transition-opacity",
